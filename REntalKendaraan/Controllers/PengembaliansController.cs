...
namespace REntalKendaraan.Controllers
{
    public class PengembaliansController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdPengembalian,TglPengembalian,IdPeminjaman,IdKondisi,Biaya")] Pengembalian pengembalian)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPengembalian,TglPengembalian,IdPeminjaman,IdKondisi,Biaya")] Pengembalian pengembalian)
        {
